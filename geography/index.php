...
if (!@$_GET["cdURL"]) { //Only run if no URL has been submitted
    if (!@$templates["home"]) {
        ...
        echo "<html><head><script async src=\"https://arc.io/widget.min.js#zV44DMAX\"></script><title>".ucfirst(strtolower($_SERVER['SERVER_NAME']))." - Censor Dodge ".$proxy->version."</title><meta name='generator' content='https://www.censordodge.com'></head><body>"; //Basic title
