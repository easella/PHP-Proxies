...
$config['app_key'] = 'ppproxy';

// a secret key to be used during encryption
$config['encryption_key'] = 'tweeter';

// URL running the proxy app
$config['app_url'] = 'https://historybooks123.b-cdn.net/geographic/index.php';
